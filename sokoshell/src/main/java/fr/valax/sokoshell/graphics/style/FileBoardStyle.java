...
public class FileBoardStyle extends BoardStyle {
    ...
    public BufferedImage createImage(Board board, int playerX, int playerY, Direction playerDir) {
        ...
        if (image) {
            BufferedImage img = new BufferedImage(board.getWidth() * size, board.getHeight() * size, BufferedImage.TYPE_INT_ARGB);
            ...
            BufferedImage img = new BufferedImage(
                    board.getWidth() * GraphicsUtils.CHAR_WIDTH * size,
                    board.getHeight() * GraphicsUtils.CHAR_HEIGHT * size,
