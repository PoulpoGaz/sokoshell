...
public class VerticalLayout implements Layout {
    ...
    private final LinkedHashMap<fr.valax.sokoshell.graphics.Component, VerticalConstraint> constraints;
    ...
    @Override
    public void addComponent(fr.valax.sokoshell.graphics.Component comp, Object c) {
    ...
    @Override
    public void removeComponent(fr.valax.sokoshell.graphics.Component component) {
        constraints.remove(component);
    }


    @Override
    public Dimension preferredSize(fr.valax.sokoshell.graphics.Component parent) {
        Dimension dim = new Dimension();

        for (int i = 0; i < parent.getComponentCount(); i++) {
            fr.valax.sokoshell.graphics.Component component = parent.getComponent(i);
    ...
    @Override
    public void layout(fr.valax.sokoshell.graphics.Component parent) {
        ...
        fr.valax.sokoshell.graphics.Component topEnd = null;
        fr.valax.sokoshell.graphics.Component botEnd = null;
    ...
    private void placeEndComponent(fr.valax.sokoshell.graphics.Component component, int topY, int botY, int parentWidth, int leftX) {
        VerticalConstraint constraint = getConstraintFor(component);
