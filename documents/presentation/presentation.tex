...
\begin{document}
    ...
    \section{Introduction}
        ...
        \begin{frame}{Lien avec le thème de l'année}
            \centering
            \only<1>{
                 \copyrightbox[b]{\includegraphics[width=0.9\textwidth]{warehouse.jpg}}
            ...
            \only<2>{
                \copyrightbox[b]{\includegraphics[width=0.9\textwidth]{city_plan.jpg}}
    ...
    % Exemple de frame de résultats intermédiaires.
    % Paramètres:
    %   5 = nombre de niveaux résolus dans XSokoban
    %   9 = nombre de niveaux résolus en plus
    %   4 = Borne max de l'intervalle d'améliorations à plot ([0, 8])
    \begin{interstateframe}
        \begin{interstatenv}{5}{9}\interstatplot{4};\end{interstatenv}
    \end{interstateframe}
