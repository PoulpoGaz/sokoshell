...
\begin{document}
    ...
    \section{Réduction de l'espace de recherche}
        ...
        \subsection{Analyse dynamique}
            ...
            \begin{frame}{\textit{PI Corral prunning}}
                \only<1> {
                    \begin{figure}
                        \centering
                ...
                \only<2>{
                    \begin{tikzpicture}
                        ...
                        \node [below=0cm of B.south] {Inutile de considérer les caisses grisés};
                    \end{tikzpicture}
    ...
    \section{Recherche dirigée par une heuristique}
        ...
        \begin{interstateframe}
            \begin{interstatenv}{15}{5 + 4}\interstatplot{7};\end{interstatenv}
        \end{interstateframe}
