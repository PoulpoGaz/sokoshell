                ...
                \centering
                 \begin{tikzpicture}[remember picture]
                    \node[visible on=<2-5>] (A) {
                        \includegraphics[width=0.35\textwidth]{corral_detection/corral_start.png}
                    };
                    \node[visible on=<3-5>, right=of A] (B) {
                        \includegraphics[width=0.35\textwidth]{corral_detection/corral_1.png}
                    };
                    \node[visible on=<4-5>,below=of A] (C) {
                        \includegraphics[width=0.35\textwidth]{corral_detection/corral_2.png}
                    };
                    \node[visible on=<5>, below=of B] (D) {
                        \includegraphics[width=0.35\textwidth]{corral_detection/corral_3.png}
                    };
                    ...
                    \node[visible on=<6-9>] (A) {%
                        \includegraphics[width=0.35\textwidth]{corral_detection/corral_4.png}%
                    };%
                    \node[visible on=<7-9>, right=of A] (B) {%
                        \includegraphics[width=0.35\textwidth]{corral_detection/corral_5.png}%
                    };%
                    \node[visible on=<8-9>,below=of A] (C) {%
                        \includegraphics[width=0.35\textwidth]{corral_detection/corral_6.png}%
                    };%
                    \node[visible on=<9>, below=of B] (D) {%
                        \includegraphics[width=0.35\textwidth]{corral_detection/corral_7.png}%
                    };%
                    ...
                    \node[visible on=<10>] (A) {%
                        \includegraphics[width=0.35\textwidth]{corral_detection/corral_8.png}%
                    };%
                \end{tikzpicture}
            }
