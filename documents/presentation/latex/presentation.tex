        ...
        \begin{frame}{Le jeu du Sokoban}
            \begin{columns}
                \begin{column}{0.3\textwidth}
                    \begin{figure}
                        \centering
                        \includegraphics[width=\columnwidth]{creator.jpg} % source: https://shmuplations.com/wp-content/uploads/2022/03/thinkingrabbit04.jpg
            ...
            \begin{columns}
                \begin{column}{0.5\textwidth}
                    \only<1-2>{
                        \begin{figure}
                            \centering
                            \includegraphics{rules/moves.png}
